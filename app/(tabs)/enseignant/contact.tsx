...
import { Search, Phone, Mail, MessageCircle, Users, User, MapPin } from 'lucide-react-native';
...
export default function TeacherContact() {
  ...
  const [activeTab, setActiveTab] = useState<'parents' | 'direction'>('parents');
  ...
  const demoContacts: Contact[] = [
    {
      ...
      role: 'parent',
      location: 'Yopougon',
      children: ['Kouadio Aya', 'N\'Dri Kevin'],
  ...
  useEffect(() => {
    const loadContacts = async () => {
      ...
      setFilteredContacts(demoContacts.filter(c => c.role === 'parent'));
      setLoading(false);
    };
      ...
      <View style={styles.contactHeader}>
        <View style={styles.contactInfo}>
          ...
          <View style={styles.contactDetails}>
            ...
            {contact.children && (
              <Text style={styles.contactChildren}>
                Enfants: {contact.children.join(', ')}
              </Text>
            )}
          </View>
        </View>
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
        ...
        <View style={styles.tabsContainer}>
          ...
          >
            <Users color={activeTab === 'parents' ? '#FFFFFF' : '#6B7280'} size={20} />
          ...
          >
            <User color={activeTab === 'direction' ? '#FFFFFF' : '#6B7280'} size={20} />
            <Text style={[styles.tabText, activeTab === 'direction' && styles.activeTabText]}>
              Direction
            </Text>
          </TouchableOpacity>
        </View>
