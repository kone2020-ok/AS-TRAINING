...
import { useThemeSettings, ThemeSettings } from '../../../contexts/ThemeContext';
...
export default function EnseignantSettingsScreen() {
                ...
                [
                  {
                    text: 'Copier',
                    onPress: () => {
                      // Ici vous pourriez copier dans le presse-papiers
    ...
    Alert.alert(
      ...
      [
        { text: 'Annuler', style: 'cancel' },
        {
          text: 'Importer',
          onPress: () => {
            // Ici vous pourriez ouvrir un sélecteur de fichier
        ...
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Séances</Text>
                <ColorPicker
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Contrats</Text>
                <ColorPicker
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Salaire</Text>
                <ColorPicker
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          ...
          <ScrollView style={styles.modalBody}>
            {/* Contraste */}
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Contraste</Text>
              <View style={styles.contrastOptions}>
                {['low', 'normal', 'high'].map((contrast) => (
                  <TouchableOpacity
                    key={contrast}
                    style={[
                      styles.contrastOption,
                      { backgroundColor: colors.card, borderColor: colors.border },
                      settings.contrast === contrast && { borderColor: colors.primary }
                    ]}
                    onPress={() => updateSettings({ contrast: contrast as any })}
                  >
                    <Contrast color={settings.contrast === contrast ? colors.primary : colors.text} size={20} />
                    <Text style={[styles.contrastOptionText, { color: colors.text }]}>
                      {contrast === 'low' ? 'Faible' : contrast === 'normal' ? 'Normal' : 'Élevé'}
                    </Text>
                  </TouchableOpacity>
                ))}
              </View>
            ...
            {/* Taille de police */}
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Taille de police</Text>
                ...
                {['small', 'medium', 'large', 'extra-large'].map((size) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      { backgroundColor: colors.card, borderColor: colors.border },
                      settings.fontSize === size && { borderColor: colors.primary }
                    ]}
                    onPress={() => updateSettings({ fontSize: size as any })}
                  >
                    <Type color={settings.fontSize === size ? colors.primary : colors.text} size={20} />
                    <Text style={[styles.fontSizeOptionText, { color: colors.text }]}>
                      {size === 'small' ? 'Petite' : size === 'medium' ? 'Moyenne' : size === 'large' ? 'Grande' : 'Très grande'}
                    </Text>
                  </TouchableOpacity>
                ))}
              </View>
            ...
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Options d'accessibilité</Text>
              
              <View style={styles.toggleSection}>
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Réduire les animations</Text>
                  ...
                  <Switch
                    ...
                    thumbColor={settings.accessibility.reduceMotion ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Texte en gras</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Rend le texte plus épais pour une meilleure lisibilité
                    </Text>
                  </View>
                  <Switch
                    value={settings.accessibility.boldText}
                    onValueChange={(value) => updateSettings({ 
                      accessibility: { ...settings.accessibility, boldText: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.accessibility.boldText ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Contraste élevé</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Améliore le contraste des éléments d'interface
                    </Text>
                  </View>
                  <Switch
                    ...
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.accessibility.highContrast ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Lecteur d'écran</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                  ...
                  <Switch
                    ...
                    onValueChange={(value) => updateSettings({ 
                      accessibility: { ...settings.accessibility, screenReader: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.accessibility.screenReader ? '#FFFFFF' : colors.text}
                  />
                </View>
              </View>
            </View>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.toggleSection}>
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Mode compact</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                  ...
                  <Switch
                    ...
                    onValueChange={(value) => updateSettings({ 
                      display: { ...settings.display, compactMode: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.display.compactMode ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Afficher les animations</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Active les animations et transitions
                    </Text>
                  </View>
                  <Switch
                    value={settings.display.showAnimations}
                    onValueChange={(value) => updateSettings({ 
                      display: { ...settings.display, showAnimations: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.display.showAnimations ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Afficher les images</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Affiche les images et avatars
                    </Text>
                  </View>
                  <Switch
                    ...
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.display.showImages ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Afficher les icônes</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Affiche les icônes dans l'interface
                    </Text>
                  </View>
                  <Switch
                    value={settings.display.showIcons}
                    onValueChange={(value) => updateSettings({ 
                      display: { ...settings.display, showIcons: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.display.showIcons ? '#FFFFFF' : colors.text}
                  />
                </View>
              </View>
            </View>
          ...
          <ScrollView style={styles.modalBody}>
            <View style={styles.section}>
              ...
              <View style={styles.toggleSection}>
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Activer les notifications</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                  ...
                  <Switch
                    ...
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.notifications.enabled ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Son</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Joue un son pour les notifications
                    </Text>
                  </View>
                  <Switch
                    ...
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.notifications.sound ? '#FFFFFF' : colors.text}
                  />
                </View>
                ...
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    ...
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Vibre lors des notifications
                    </Text>
                  </View>
                  <Switch
                    value={settings.notifications.vibration}
                    onValueChange={(value) => updateSettings({ 
                      notifications: { ...settings.notifications, vibration: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.notifications.vibration ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Badges</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                  ...
                  <Switch
                    ...
                    onValueChange={(value) => updateSettings({ 
                      notifications: { ...settings.notifications, badges: value } 
                    })}
                    trackColor={{ false: colors.border, true: colors.primary }}
                    thumbColor={settings.notifications.badges ? '#FFFFFF' : colors.text}
                  />
                </View>
              </View>
            </View>
