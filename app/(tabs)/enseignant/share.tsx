...
interface ShareItem {
  ...
  type: 'session' | 'contract' | 'report' | 'data';
  lastShared?: string;
  recipients?: string[];
  isPublic?: boolean;
}

export default function EnseignantShareScreen() {
  ...
  const shareItems: ShareItem[] = [
    {
      id: 'sessions',
      title: 'Mes séances',
      description: 'Historique et planification des séances',
      icon: Clock,
      type: 'session',
      lastShared: 'Hier à 15:30',
      recipients: ['direction@astra.com', 'parent.martin@email.com'],
    },
    {
      id: 'contracts',
      title: 'Mes contrats',
      description: 'Contrats actifs et terminés',
      icon: FileText,
      type: 'contract',
      lastShared: 'Aujourd\'hui à 11:15',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'reports',
      title: 'Rapports de performance',
      description: 'Rapports mensuels et évaluations',
      icon: TrendingUp,
      type: 'report',
      lastShared: 'Lundi à 14:20',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'students',
      title: 'Mes élèves',
      description: 'Liste et progression des élèves',
      icon: Users,
      type: 'data',
      lastShared: 'Vendredi à 09:45',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'schedule',
      title: 'Mon planning',
      description: 'Planning des séances et disponibilités',
      icon: Calendar,
      type: 'session',
      lastShared: 'Aujourd\'hui à 08:00',
      recipients: ['direction@astra.com'],
    },
  ];
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>
            Mes éléments partageables
          </Text>
          <Text style={[styles.sectionDescription, { color: colors.text + '80' }]}>
            Partagez vos séances, contrats et rapports avec la direction ou les parents
          </Text>
        </View>
        ...
        <View style={styles.infoSection}>
          <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.infoText, { color: colors.text }]}>
              Le partage est limité aux destinataires autorisés selon vos permissions.
            </Text>
          </View>
        </View>
      </ScrollView>
