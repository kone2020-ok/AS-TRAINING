...
export default function ParentProfileScreen() {
  ...
  // Données du profil Parent
  const [profileData, setProfileData] = useState<ProfileData>({
    id: 'PAR-001',
    name: 'Sophie Martin',
    email: 'sophie.martin@email.com',
    phone: '+33 6 98 76 54 32',
    address: '789 Rue des Familles, 75003 Paris',
    role: 'Parent',
    joinDate: '05/09/2022',
    avatar: undefined,
    children: [
    ...
    totalInvoices: 8,
    totalPayments: 6,
    lastLogin: 'Aujourd\'hui à 10:15',
    qrCode: 'PAR-001-QR-2024',
  });
    ...
    >
      ...
      <View style={styles.avatarSection}>
        ...
        <View style={styles.childrenCount}>
          <Baby color="#FFFFFF" size={16} />
          <Text style={styles.childrenCountText}>{profileData.children.length} enfant(s)</Text>
        </View>
      </View>
    </LinearGradient>
  );
        ...
        {profileData.children.map((child, index) => (
          <View key={child.id} style={[styles.childCard, { backgroundColor: colors.card }]}>
            <View style={styles.childHeader}>
              <View style={[styles.childIcon, { backgroundColor: colors.primary + '20' }]}>
              ...
              <View style={styles.childInfo}>
                ...
                <Text style={[styles.childTeacher, { color: colors.text + '60' }]}>
                  Enseignant: {child.teacher}
                </Text>
              </View>
            </View>
            <View style={styles.childSubjects}>
              <Text style={[styles.subjectsTitle, { color: colors.text + '60' }]}>Matières:</Text>
              <View style={styles.subjectsList}>
                {child.subjects.map((subject, subIndex) => (
                  <View key={subIndex} style={[styles.subjectTag, { backgroundColor: colors.primary + '20' }]}>
      ...
      <View style={styles.infoSection}>
        ...
        <View style={styles.statsContainer}>
          <View style={[styles.statCard, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.statNumber, { color: colors.text }]}>{profileData.totalContracts}</Text>
            <Text style={[styles.statLabel, { color: colors.text + '60' }]}>Contrats</Text>
          </View>

          <View style={[styles.statCard, { backgroundColor: colors.card }]}>
            <Receipt color={colors.primary} size={24} />
            <Text style={[styles.statNumber, { color: colors.text }]}>{profileData.totalInvoices}</Text>
            <Text style={[styles.statLabel, { color: colors.text + '60' }]}>Factures</Text>
          </View>

          <View style={[styles.statCard, { backgroundColor: colors.card }]}>
            <DollarSign color={colors.primary} size={24} />
            <Text style={[styles.statNumber, { color: colors.text }]}>{profileData.totalPayments}</Text>
            <Text style={[styles.statLabel, { color: colors.text + '60' }]}>Paiements</Text>
          </View>
        </View>
      </View>

      <View style={styles.infoSection}>
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Informations système</Text>
        ...
        <View style={styles.infoItem}>
          ...
          <View style={styles.infoContent}>
            <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Code QR</Text>
            <Text style={[styles.infoValue, { color: colors.text }]}>{profileData.qrCode}</Text>
          </View>
        </View>
        ...
        <View style={styles.infoItem}>
          ...
          <View style={styles.infoContent}>
            <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Date d'inscription</Text>
