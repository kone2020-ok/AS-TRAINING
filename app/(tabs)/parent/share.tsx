...
interface ShareItem {
  ...
  type: 'qr' | 'contract' | 'invoice' | 'child' | 'data';
  lastShared?: string;
  recipients?: string[];
  isPublic?: boolean;
}

export default function ParentShareScreen() {
  ...
  const shareItems: ShareItem[] = [
    {
      id: 'qr-code',
      title: 'Mon QR Code',
      description: 'Code QR pour accès aux séances',
      icon: QrCode,
      type: 'qr',
      lastShared: 'Aujourd\'hui à 14:30',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'contracts',
      title: 'Mes contrats',
      description: 'Contrats actifs et historique',
      icon: FileText,
      type: 'contract',
      lastShared: 'Hier à 16:45',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'invoices',
      ...
      icon: Receipt,
      type: 'invoice',
      lastShared: 'Lundi à 11:20',
      recipients: ['comptabilite@astra.com'],
    },
    {
      id: 'children',
      title: 'Mes enfants',
      description: 'Informations sur mes enfants',
      icon: Baby,
      type: 'child',
      lastShared: 'Vendredi à 09:15',
      recipients: ['direction@astra.com'],
    },
    {
      id: 'payments',
      ...
      icon: DollarSign,
      type: 'data',
      lastShared: 'Aujourd\'hui à 10:00',
      recipients: ['comptabilite@astra.com'],
    },
  ];
  ...
  const handleGenerateQRCode = () => {
    Alert.alert(
      'QR Code généré',
      'Votre QR Code a été généré et peut être partagé',
      [
        { text: 'Partager', onPress: () => console.log('QR Code partagé') },
        { text: 'Fermer' },
      ]
    );
  };
      ...
      <View style={styles.shareActions}>
        {item.type === 'qr' && (
          ...
          >
            ...
            <Text style={[styles.actionButtonText, { color: colors.primary }]}>Générer QR</Text>
          </TouchableOpacity>
        )}
        <TouchableOpacity
          style={[styles.actionButton, { backgroundColor: colors.primary + '20' }]}
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={[styles.sectionDescription, { color: colors.text + '80' }]}>
            Partagez vos QR Codes, contrats et factures avec la direction
          </Text>
        </View>
