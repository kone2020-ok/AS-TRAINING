...
export default function DirectionSettingsScreen() {
  ...
  const handleManagementSettings = () => {
  ...
  const settingsData: SettingItem[] = [
    ...
    },
    {
      ...
      description: 'Paramètres spécifiques à la direction',
      icon: Building,
      type: 'button',
      onPress: handleManagementSettings,
    },
    {
      id: 'notifications',
      title: 'Notifications',
        ...
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Gestion des enseignants</Text>
                <ColorPicker
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Gestion des parents</Text>
                <ColorPicker
              ...
              <View style={styles.colorSection}>
                <Text style={[styles.colorLabel, { color: colors.text }]}>Finances</Text>
                <ColorPicker
  ...
  const renderManagementModal = () => (
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          <View style={styles.modalHeader}>
            <Text style={[styles.modalTitle, { color: colors.text }]}>Gestion d'entreprise</Text>
          ...
          <ScrollView style={styles.modalBody}>
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Paramètres de direction</Text>
              
              <View style={styles.toggleSection}>
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Approbation automatique</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Approuver automatiquement les demandes simples
                    </Text>
                  </View>
                  <Switch
                    value={false}
                    ...
                    thumbColor={false ? '#FFFFFF' : colors.text}
                  />
                </View>

                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Notifications critiques</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                ...
                <View style={styles.toggleItem}>
                  <View style={styles.toggleInfo}>
                    <Text style={[styles.toggleTitle, { color: colors.text }]}>Mode entreprise</Text>
                    <Text style={[styles.toggleDescription, { color: colors.text + '60' }]}>
                      Interface optimisée pour la gestion d'entreprise
                    </Text>
                  </View>
                  <Switch
                    value={true}
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          ...
          <ScrollView style={styles.modalBody}>
            {/* Contenu similaire à l'enseignant */}
            <View style={styles.section}>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Paramètres Direction</Text>
